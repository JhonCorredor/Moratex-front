...
@Component({
  selector: 'app-maquinarias-index',
  templateUrl: './maquinarias-index.component.html',
  styleUrls: ['./maquinarias-index.component.css']
})
export class MaquinariasIndexComponent implements OnInit {
  ...
  public API_URL : any;
  public title = "Listado de maquinarias";
  public breadcrumb = [{name: `Inicio` , icon: `fa-solid fa-house`},  {name: 'Tallaje'} , {name: 'Maquinarias' }];
  ...
  cargarDatatable() {
    ...
    that.opcionesDataTable = {
        ...
        ajax: (dataTablesParameters: any, callback : any) => {
          ...
          this.service.datatable("Maquinarias", data).subscribe(res => {
            callback({
        ...
        drawCallback: (settings : any) => {
          $('.btn-dropdown-modificar').off().on('click', (event : any) => {
            let modal = this.modalService.open(MaquinariasFormComponent, {size: 'lg', keyboard: false, backdrop: "static"});
