...
@Component({
  selector: 'app-piezas-index',
  templateUrl: './piezas-index.component.html',
  styleUrls: ['./piezas-index.component.css']
})
export class PiezasIndexComponent implements OnInit {
  ...
  constructor(private service: PiezasService, private helperService: HelperService,
     private route: Router, private modalService: NgbModal) { 
    this.title = `Listado de Piezas`;
    this.breadcrumb = [{name: `Inicio` , icon: `fa-solid fa-house`},  {name: "Tallaje" , icon: "fas fa-cogs"}, {name: "Piezas" }];
  }
  ...
  cargarDatatable() {
    ...
    that.opcionesDataTable = {
        ...
        ajax: (dataTablesParameters: any, callback : any) => {
          ...
          this.service.datatable("piezas", data).subscribe(res => {
            callback({
  ...
  public nuevo() {
    this.helperService.redirectApp(`tallaje/piezas/crear`);
  }
}
