...
@Component({
  selector: 'app-generalidades-index',
  templateUrl: './generalidades-index.component.html',
  styleUrls: ['./generalidades-index.component.css']
})
export class GeneralidadesIndexComponent implements OnInit { 
  ...
  public API_URL : any;
  public title = "Listado De Generalidades";
  public breadcrumb = [{name: `Inicio` , icon: `fa-solid fa-house`},  {name: "Tallaje" , icon: "fas fa-cogs"}, {name: "Generalidades"}];
  public botones: String[] = ['btn-nuevo'];
  public arrayBotonesDatatable: String[] = ['btn-modificar', 'btn-eliminar'];
  constructor(private service: GeneralidadesService,
  ...
  cargarDatatable() {
    ...
    that.opcionesDataTable = {
        ...
        ajax: (dataTablesParameters: any, callback : any) => {
          ...
          this.service.getAllGeneralidades(data).subscribe((res : any) => {
            callback({
        ...
        drawCallback: (settings : any) => {
          $('.btn-dropdown-modificar').off().on('click', (event : any) => {
            this.helperService.redirectApp(`tallaje/generalidades/editar/${event.target.dataset.id}`);
          });
  ...
  public nuevo() {
    this.helperService.redirectApp('tallaje/generalidades/crear');
  }
