...
export class ModelosCriteriosService {

  private BASE_URL = environment.url + "ModelosCriterios/";
  ...
  public getAllModelosCriterios( data : DatatableParameter) : Observable<any> {
  ...
  public getModelosCriteriosById(id : any) : Observable<any> {
