...
@Component({
  selector: 'app-prendas-index',
  templateUrl: './prendas-index.component.html',
  styleUrls: ['./prendas-index.component.css']
})
export class PrendasIndexComponent implements OnInit {
  ...
  public API_URL : any;
  public title = "Listado Prendas";
  public breadcrumb = [{name: `Inicio` , icon: `fa-solid fa-house`},  {name: "Tallaje" , icon: "fas fa-cogs"}, {name: "Prendas"}];
  public botones: String[] = ['btn-nuevo'];
  public arrayBotonesDatatable: String[] = ['btn-modificar', 'btn-eliminar'];
  constructor(private service: PrendasService, private helperService: HelperService) { }
    ...
    that.opcionesDataTable = {
        ...
        drawCallback: (settings : any) => {
          $('.btn-dropdown-modificar').off().on('click', (event : any) => {
            this.helperService.redirectApp(`tallaje/prendas/editar/${event.target.dataset.id}`);
          });
  ...
  public nuevo() {
    this.helperService.redirectApp('tallaje/prendas/crear');
  }
