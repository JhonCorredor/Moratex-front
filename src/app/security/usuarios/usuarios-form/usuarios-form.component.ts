...
export class UsuariosFormComponent implements OnInit {
  ...
  public titulo = "";
  public listPersonas = [];
  public breadcrumb = [{name: `Inicio` , icon: `fa-solid fa-house`},  {name: "Seguridad" , icon: "fas fa-cogs"}, {name: "Usuario"}, {name: "Crear"}];
  ...
  save() {
    ...
    this.service.save(this.id, data).subscribe(l => {
      if (!l.status) {
        ...
        this.helperService.redirectApp(`seguridad/usuarios/editar/${l.data.id}`)
