...
@Component({
  ...
  styleUrls: ['./formularios-index.component.css']
})
  ...
  cargarDatatable() {
    ...
    that.opcionesDataTable = {
        ...
        ajax: (dataTablesParameters: any, callback : any) => {
          ...
          this.service.getAllFormularios(data).subscribe((res : any) => {
            callback({
        ...
        columns: [
            ...
            },
            {
              ...
              render: function(item : any) {
                ...
                return `${item}  <a  class="badge bg-secondary text-right" href="${document.location.origin}/${item}">Ver</a>`;
            }
            },
            {
              title: "Modulo",
        ...
        drawCallback: (settings : any) => {
          $('.btn-dropdown-modificar').off().on('click', (event : any) => {
            let modal = this.modalService.open(FormulariosFormComponent, {size: 'lg', keyboard: false, backdrop: "static"});
