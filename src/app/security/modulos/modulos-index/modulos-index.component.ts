...
@Component({
  ...
  styleUrls: ['./modulos-index.component.css']
})
export class ModulosIndexComponent implements OnInit {
  ...
  constructor(private service: ModulosService, private helperService: HelperService, private modalService: NgbModal) { 
  }
    ...
    that.opcionesDataTable = {
        ...
        drawCallback: (settings : any) => {
          $('.btn-dropdown-modificar').off().on('click', (event : any) => {
            let modal = this.modalService.open(ModulosFormComponent, {size: 'lg', keyboard: false, backdrop: "static"});
