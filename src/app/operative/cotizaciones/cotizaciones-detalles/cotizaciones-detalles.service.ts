...
export class CotizacionesDetallesService {
  ...
  private BASE_URL = environment.url + "CotizacionesDetallesManuales/";
  ...
  public getAllCotizacionesDetalles( data : DatatableParameter) : Observable<any> {
  ...
  public getCotizacionesDetallesById(id : any) : Observable<any> {
