...
@Component({
  selector: 'app-empleadosMedidas-index',
  templateUrl: './ordenes-compra-index.component.html',
  styleUrls: ['./ordenes-compra-index.component.css']
})
export class OrdenesCompraIndexComponent implements OnInit { 
  ...
  public API_URL : any;
  public title = "Listado de Empleados Medidas";
  public breadcrumb = [{name: `Inicio` , icon: `fa-solid fa-house`},  {name: "Configuracion"}, { name : "Ubicacion" }, {name: "Empleados Medidas"}];
  public botones: String[] = ['btn-nuevo'];
  public arrayBotonesDatatable: String[] = ['btn-modificar', 'btn-eliminar'];
  constructor(private service: OrdenesCompraService, private helperService: HelperService, 
  ...
  cargarDatatable() {
    ...
    that.opcionesDataTable = {
        ...
        ajax: (dataTablesParameters: any, callback : any) => {
          ...
          this.service.getAllOrdenesCompra(data).subscribe(({data}) => {
            callback({
              recordsTotal: data.lenght,
              recordsFiltered: data.lenght,
        ...
        drawCallback: (settings : any) => {
          $('.btn-dropdown-modificar').off().on('click', (event : any) => {
            let modal = this.modalService.open(OrdenesCompraFormComponent, {size: 'lg', keyboard: false, backdrop: "static"});
