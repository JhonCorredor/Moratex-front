...
export class OrdenesCompraService {
  ...
  private BASE_URL = environment.url + "OrdenesCompra/";
  ...
  public getAllOrdenesCompra( data : DatatableParameter) : Observable<any> {
  ...
  public getOrdenesCompraById(id : any) : Observable<any> {
