...
export class FacturasComprasDetallesPagosService {

  private url = environment.url;
  private ruta =  "FacturasComprasDetallesPagos";
  ...
  public getAllFacturasDetallesPagos( data : DatatableParameter) : Observable<any> {
