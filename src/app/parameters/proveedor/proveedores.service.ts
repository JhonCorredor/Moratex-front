...
export class ProveedoresService {
  ...
  private BASE_URL = environment.url + "Proveedores/";
  ...
  public getAllProveedores( data : DatatableParameter) : Observable<any> {
  ...
  public getProveedoresById(id : any) : Observable<any> {
