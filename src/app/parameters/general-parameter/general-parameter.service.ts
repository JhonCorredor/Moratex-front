...
export class GeneralParameterService {
  ...
  public datatableAgg(ruta: String, data: DatatableParameter) : Observable<any> {
    return this.http.get<any>(`${this.url}${ruta}/datatable?&ForeignKey=${data.foreignKey}`, {headers: this.header})
  }
  ...
  public getAllCustom(ruta: String) : Observable<any> {
    return this.http.get<any>(`${this.url}${ruta}`, {headers: this.header});
  }
