...
export class InventarioDetalleBodegaService {

  private BASE_URL = environment.url + "DetallesInventariosBodegas/";
  ...
  public getAllInventarioDetalleBodega( data : DatatableParameter) : Observable<any> {
  ...
  public getInventarioDetalleBodegaById(id : any) : Observable<any> {
