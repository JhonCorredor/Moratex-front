...
export class InventariosIndexComponent implements OnInit {
  ...
  public API_URL : any;
  public title = "Listado de Inventarios";
  public breadcrumb = [{name: `Inicio` , icon: `fa-solid fa-house`}, {name: "Inventario" , icon: "fas fa-cogs"}, {name: "Inventarios"}];
  public botones: String[] = ['btn-nuevo'];
  public arrayBotonesDatatable: String[] = ['btn-modificar', 'btn-eliminar'];
  constructor(private service: InventariosService, private helperService: HelperService, private route: Router, private modalService: NgbModal) { }
    ...
    that.opcionesDataTable = {
        ...
        drawCallback: (settings : any) => {
          $('.btn-dropdown-modificar').off().on('click', (event : any) => {
            this.helperService.redirectApp(`/inventario/inventarios/editar/${event.target.dataset.id}`);
          });
  ...
  public nuevo() {
    this.helperService.redirectApp(`inventario/inventarios/crear`);
  }
}
