...
export class BitacorasInventariosService {

  private BASE_URL = environment.url + "BitacorasInventarios/";
  ...
  public getAllBitacoraInventario( data : DatatableParameter) : Observable<any> {
  ...
  public getBitacoraInventarioById(id : any) : Observable<any> {
